...
public class Internet extends AppCompatActivity implements AdapterView.OnItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        web =(WebView) findViewById(R.id.wvInternet);
            ...
            switch (position) {
                ...
                case 0://menu
                  ...
                  //  msg = "You are already There";
                    Intent goingToMenuIntent = new Intent(Internet.this,Menu.class);
                    startActivity(goingToMenuIntent);
                    break;
                case 1://phone
                    msg = "Going to Phone";
                    //msg = "You are already There";
                    Intent goingToPhoneIntent = new Intent(Internet.this,PhoneCall.class);
                    startActivity(goingToPhoneIntent);
                    break;
                case 2://camera
                    msg = "Going to Camera";
                    //msg = "You are already There";
                    Intent goingToCameraIntent = new Intent(Internet.this,Camera.class);
                    startActivity(goingToCameraIntent);
                    break;
                case 3://gallery
                    msg = "Going to Gallery";
                    //msg = "You are already There";
                    Intent goingToGalleryIntent = new Intent(Internet.this,Gallery.class);
                    startActivity(goingToGalleryIntent);
                    break;
                case 4://internet
                    //msg = "Going to Internet";
                    msg = "You are already There";
                    //Intent goingToInternetIntent = new Intent(Internet.this,Internet.class);
